...
public class PrintTicket1 extends JFrame
{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		...
		JLabel LYnez=new JLabel("<html><I><font color=\"#8FBC8F\">Ynez Prem Dias</font></I></html>");
		JLabel LPooja=new JLabel("<html><I><font color=\"#8FBC8F\">Pooja Aagale</font></I></html>");
		JLabel LShawn=new JLabel("<html><I><font color=\"#8FBC8F\">Shawn Dsilva</font></I></html>");
		...
		LYnez.setBounds(285,485,300,20);
		LPooja.setBounds(285,505,300,20);
		LShawn.setBounds(285,525,300,20);
